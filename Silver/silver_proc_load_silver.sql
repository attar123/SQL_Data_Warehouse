...
===============================================================================
Purpose:
    Executes the ETL (Extract, Transform, Load) pipeline to move and cleanse data 
    from the 'bronze' schema and populate corresponding tables in the 'silver' schema.

Process Overview:
    - Truncates target Silver tables.
    - Transforms and inserts cleaned data from Bronze tables.

Parameters:
    None — This procedure takes no input parameters and does not return any result set.
...
BEGIN
    ...
    BEGIN TRY
        ...
        PRINT '================================================';
        PRINT 'Initiating Silver Layer Load';
        PRINT '================================================';
